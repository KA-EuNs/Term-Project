...
class Expenditure extends JPanel implements MouseListener 
{
 ...
 g.drawString("잔액 " + currentMoney, 220, 320);
	/*
	 * Label previous = new Label("이전 달 지출내역");
	 * previous.setBackground(Color.yellow); previous.setBounds(12, 5, 100, 20);
	 * add(previous); previous.addMouseListener((MouseListener) this);
	 */
 	Label previous;
 	

 	previous = new Label("이전 달 지출내역");
 	previous.setBounds(12, 5, 100, 20);
 	previous.setBackground(Color.yellow);
 	add(previous);
	previous.addMouseListener((MouseListener) this);
 }


	 
 public static void main(String args[]) {
	 Expenditure gui = new Expenditure();
		gui.setVisible(true);
 }
...
public void mouseClicked(MouseEvent e) {
	// TODO Auto-generated method stub
	 new PreviousExpense(); //여기가 프레임 전환 역할
