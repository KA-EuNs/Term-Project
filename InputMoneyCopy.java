...
public class InputMoneyCopy extends Check implements Serializable {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		try {
				ObjectOutputStream thisOutputStream = new ObjectOutputStream(new FileOutputStream (fileName1));//�씠踰덈떖 吏�異쒕궡�뿭 �엯�젰//
				InputMoney money = new InputMoney(); //�씠踰덈떖 吏�異쒕궡�뿭 珥덇린 �꽕�젙//
				money.setIncome(600000); //�닔�엯//
				money.setExpenditure(350000); //吏�異�//
				money.setCategoryFood(70000); //�떇鍮�//
				money.setCategoryTransportation(50000);//援먰넻鍮�//
				money.setCategoryLeisure(50000); //�뿬媛�鍮�//
				money.setCategoryCommunication(70000); //�넻�떊鍮�//
				money.setCategoryMedical(10000); //�쓽猷뚮퉬//
				money.setCategoryLifeCost(60000); //�깮�솢鍮�//
				money.setCategoryEtc(40000); //湲고� 鍮꾩슜//
